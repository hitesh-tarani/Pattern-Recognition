function confmatrix_multi(files,m1,m2,m3,p1,p2,p3,s1,s2,s3)
% fileno=strsplit(files{:},'\');
file=strcat(files,'testingClass1.txt');
t1 = importdata(file);
file=strcat(files,'testingClass2.txt');
t2 = importdata(file);
file=strcat(files,'testingClass3.txt');
t3 = importdata(file);
