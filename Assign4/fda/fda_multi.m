...
for i=1:no_of_classes-1
    for j=i+1:no_of_classes
        ...
        newdata2=c(j).data*w;
        k=3;
        [class(i,j).m(1).data, class(i,j).p(1).data, class(i,j).v(1).data]=code(newdata1,k);
        [class(i,j).m(2).data, class(i,j).p(2).data, class(i,j).v(2).data]=code(newdata2,k);
...
%     testdata=importdata(strcat(file,class1(i).file,'/testing/concat.dt'));
    ...
    g_testdata1_1=density(testdata*class(1,2).w,class(1,2).m(1).data,class(1,2).p(1).data,class(1,2).v(1).data);
    g_testdata1_2=density(testdata*class(1,2).w,class(1,2).m(2).data,class(1,2).p(2).data,class(1,2).v(2).data);
    g_testdata2_1=density(testdata*class(1,3).w,class(1,3).m(1).data,class(1,3).p(1).data,class(1,3).v(1).data);
    g_testdata2_3=density(testdata*class(1,3).w,class(1,3).m(2).data,class(1,3).p(2).data,class(1,3).v(2).data);
    g_testdata3_2=density(testdata*class(2,3).w,class(2,3).m(1).data,class(2,3).p(1).data,class(2,3).v(1).data);
    g_testdata3_3=density(testdata*class(2,3).w,class(2,3).m(2).data,class(2,3).p(2).data,class(2,3).v(2).data);
